      ...
      <div className="auth-shell">
        <section className="auth-story">
          <a className="auth-brand" href="#/" aria-label="KYNEX home">
            <span className="auth-brand-mark"><img src="/kynex-logo.png" alt="" /></span>
            <span><strong>KYNEX</strong><small>Material identity resolution platform</small></span>
          </a>
          ...
          <div className="auth-proof-list" aria-label="KYNEX access principles">
            ...
            <span><CheckCircle2 size={15} /> Conflicts remain visible</span>
            <span><CheckCircle2 size={15} /> Publishing stays accountable</span>
          </div>
        </section>

        <section className="auth-card" aria-labelledby="auth-title">
          <div className="auth-card-heading">
            <span className="auth-card-kicker"><LockKeyhole size={14} /> Secure workspace access</span>
            <h2 id="auth-title">{mode === 'sign-in' ? 'Welcome back.' : 'Create your workspace account.'}</h2>
            <p>{mode === 'sign-in' ? 'Sign in to continue to KYNEX.' : 'Use an email account to save your workspace session.'}</p>
          </div>
